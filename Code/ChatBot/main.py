...
class Chatbot:
    ...
    def __init__(self):
        ...
        self.intents = [
            ...
            {
                "patterns": ["what is your name","What is the name of the entity responding to these queries"],
                "responses": ["Steger Center Bot"]
            },
            {
            ...
            {
                "patterns": ["project-based learning", "directed research projects"],
            ...
            {
                "patterns": ["location of Steger Center", "where is Steger Center","Location","Where is the Steger Center located?"],
            ...
            {
                "patterns": ["recommended towns", "towns to visit", "places to visit in Ticino", "what towns are recommended to visit in Ticino, Switzerland","towns recommends"],
            ...
            {
                "patterns": ["landmarks in Riva San Vitale", "landmarks in Riva San Vitale", "what landmarks can found in riva "],
            ...
            {
                "patterns": ["attractions", "to do in Lugano", "places to visit in Lugano"],
            ...
            {
                "patterns": ["Social norms and behavior in Switzerland", "Swiss social customs","What are the social norms and behavior in Switzerland?"],
            ...
            {
                "patterns": ["Language use in Switzerland", "Swiss language "],
            ...
            {
                "patterns": ["Greeting in Italian", "Italian greeting","what is the common Italian greeting "],
            ...
            {
                "patterns": ["operating hours", "Center hours","what is the operating houres of steger center?"],
                "responses": ["The Steger Center is open Monday through Friday from 08:00 to 18:00."]
            },
            {
                "patterns": ["Contact information","email","telephone", "Center contact info","contact steger center"],
                "responses": ["You can contact the Steger Center via email at stegercenter@vt.edu or by telephone at (011) 41 91 648 3651."]
            },
            {
                "patterns": ["address for the Steger Center", "Center address","what is the address of steger center "],
